...
driver = webdriver.Chrome(executable_path=r"C:\Users\User_Name\Documents\chromedriver.exe") ##### Add the path to chormedriver.exe file and add your name in the path, If not available, download it
time.sleep(10)  
